...
HD_PWD='F:/GitHub/Integer_Clk_Division/FPGA_Implementation/clk_divider/clk_divider.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_div.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_div.tcl
