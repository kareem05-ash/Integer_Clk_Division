...
HD_PWD='F:/GitHub/Integer_Clk_Division/FPGA_Implementation/clk_divider/clk_divider.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_div.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clk_div.tcl -notrace
